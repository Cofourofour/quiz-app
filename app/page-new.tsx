      ...
      <main className="container mx-auto px-4 py-12 md:py-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl mb-8 leading-relaxed" style={{ color: 'var(--text)' }}>
            Discover your nomad personality type with our quick 6-question quiz. 
            Learn which destinations, work styles, and travel approaches align with your preferences.
          </p>
